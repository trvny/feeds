...
internal data class ReaderNavigationState(
    ...
    fun openArticle(item: NewsItem): ReaderNavigationState = copy(route = ReaderRoute.ARTICLE, selectedArticle = item)

    fun open(route: ReaderRoute): ReaderNavigationState = copy(route = route, selectedArticle = null)
